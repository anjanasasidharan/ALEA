...
class AdvancedSpaceShared extends AllocPolicy {
    ...
    public void gridletSubmit(Gridlet gl, boolean ack) {
        ...
        if (expected_runtime > (time_limit)) {
            ...
            //System.out.println(gl.getGridletID()+" exceeds time limit by :"+ Math.round(expected_runtime - time_limit)/60+" minutes, limit = "+(time_limit)/3600);
