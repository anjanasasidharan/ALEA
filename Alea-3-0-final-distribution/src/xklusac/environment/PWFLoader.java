...
public class PWFLoader extends GridSim {
    ...
    public void body() {
        ...
        super.sim_schedule(this.getEntityId("Alea_3.0_scheduler"), 0.0, 612345, null);
        Sim_event ev = new Sim_event();
        sim_get_next(ev);
    ...
    private ComplexGridlet readGridlet(int j) {
        ...
        ComplexGridlet gl = new ComplexGridlet(id, "John_Doe", job_limit, new Double(length), new Double(estimated), 10, 10, "Linux", "Risc arch.", arrival, deadline_d, 1, numCPU, estimatedMachine, "q3", "", perc);
