...
/**
 * Class GridletInfo<p>
 * This class creates an object handling information about gridlets. It use set / get methods to set / get information about
 * gridlet. It stores various information of real gridlet. If more information required, this
 * is the right place to store them (see set/getTardiness(gridletInfo) method) rather then changing
 * ComplexGridlet class (if possible).
...
public class GridletInfo {
    ...
    /** It denotes this dynamicaly changing information: time_to_release = max(0.0, (arrival_time + release_date) - current_time) */
     ...
     * @param gl - Gridlet - the constructor gets the important informations about gridlet and
     *                  sets them to inner variables
     */
