...
public class GWFLoader extends GridSim {
    ...
    public void body() {
        ...
        super.sim_schedule(this.getEntityId("Alea_3.0_scheduler"), earliest_end_time, 612345, new Integer(submitted));
        Sim_event ev = new Sim_event();
        sim_get_next(ev);
    ...
    private ComplexGridlet readGridlet(int j) {
        ...
        double perc = 0.0;
        ComplexGridlet gl = new ComplexGridlet(id, "J", job_limit, new Double(length), estimatedLength, 10, 10, null, null, arrival, deadline, 1, numCPU, 0.0, queue, properties, perc);
